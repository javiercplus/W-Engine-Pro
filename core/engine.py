...
class MpvEngine(WallpaperEngineInterface):
    ...
    def __init__(self, config, surface_manager, monitor_id):
        ...
        try:
            ...
            logging.info(f"[MpvEngine] Instancia de libmpv creada y adjuntada a la ventana {wid}")
        except Exception as e:
            logging.error(f"[MpvEngine] No se pudo inicializar libmpv. ¿Está instalada la librería? Error: {e}")
            raise
