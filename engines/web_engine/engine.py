...
class WebEngine(WallpaperEngineInterface):
    ...
    def init(self, surface_handle, monitor_info):
        ...
        self.webview.setWindowFlags(Qt.FramelessWindowHint | Qt.WindowStaysOnBottomHint | Qt.Tool)
        self.webview.setAttribute(Qt.WA_TranslucentBackground)
        self.webview.resize(monitor_info['resolution'][0], monitor_info['resolution'][1])
